...
static tbsla::hpx_::client::Vector tbsla::hpx_::detail::spmv_part(tbsla::hpx_::client::MatrixCOO const& A_p, tbsla::hpx_::client::Vector const& v_p, tbsla::hpx_::client::Vector const& r_p) {
  using hpx::dataflow;
  ...
  return dataflow(hpx::launch::async,
    unwrapping([r_p](tbsla::hpx_::detail::MatrixCOO const& A, tbsla::hpx_::detail::Vector const& v) -> tbsla::hpx_::client::Vector {
